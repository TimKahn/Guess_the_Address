...
if __name__ == '__main__':
    ...
    smt = SMOTETomek(ratio=.01, n_jobs=-1)
    sme = SMOTEENN(ratio=.01, n_jobs=-1)
    # gnb = GaussianNB()
    ...
    xg2 = XGBClassifier(scale_pos_weight=10, max_delta_step=1, colsample_bytree=.5, colsample_bylevel=1, seed=42)
    ...
    # profit_avg.plot_avg_profits(xg2, filename, revenue=50, cost=1)
    rc2.plot_ROC_curve(classifiers, X, y, balancing=balancing, benchmarks=(.4, .7), save_path=None)
